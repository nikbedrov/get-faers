...
for index, drugevent in enumerate(drug_event_AB.values):
    ...
    row = (drugname, drugevent[0], drugevent[1], drug_AB.values[0][1], ac_count, faers_all_cases )
